...
<form id="tta-ticket-edit-form">
  ...
  <p class="submit">
    ...
    <div class="tta-admin-progress-spinner-div">
        <img class="tta-admin-progress-spinner-svg" src="/wp-content/plugins/tta-management-plugin/assets/images/admin/loading.svg" alt="Loading…" style="display:none; opacity:0;">
    </div>
